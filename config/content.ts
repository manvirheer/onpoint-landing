  ...
  },
  {
    ...
    services: [
...

      {
        ...
        detailed: [
          "We offer an advanced traffic control training course that will qualify Lane Closure Technicians (LCT).  LCT’s can direct other TCPs and play an essential role in setting up and maintaining efficient lane closures as well as prioritizing the safety of everyone involved for peace of mind for employees and clients.",
          ],
        image: "/images/traffic-1.jpg",
        link: "/services",
        // features: [
